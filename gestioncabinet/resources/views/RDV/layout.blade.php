...
<li class="nav-item">
<a class="nav-link text-white active " href="../rdv" style="background-color:#9c27b0;">
<div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
...
<li class="nav-item">
<a class="nav-link text-white " href="../ordonnance">
<div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
...
<div class="mx-3">
<a class="btn  mt-4 w-100" href="{{ url('/login') }}" type="button" style="background-color:#9c27b0;color:white;">Cabinet</a>
</div>
</div>
</aside>
<!-- END MENU LEFT--> 
